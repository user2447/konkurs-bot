...
def start_handler(message):
    ...
    bot.send_message(chat_id, "🚀 Konkursda ishtirok etish uchun majburiy kanallarga obuna bo‘ling va 'Obuna bo'ldim ✅' tugmasini bosing", reply_markup=markup)
...
def text_handler(message):
    ...
    if text == "🔴 Konkursda qatnashish":
        bot.send_message(chat_id, "Konkurs tafsilotlari ...")
    elif text == "🎁 Sovgalar":
        ...
        bot.send_message(chat_id, "Konkurs shartlari ...")
    elif text == "🟢 Refeal link":
        bot.send_message(chat_id, f"🔗 Sizning referral linkingiz:\nhttps://t.me/ixtiyor_rp_bot?start={chat_id}")
